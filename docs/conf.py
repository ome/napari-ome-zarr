# -*- coding: utf-8 -*-
#
# napari-ome-zarr documentation build configuration file, created by
...
project = u'napari-ome-zarr'
copyright = u'2015, OME Team'
author = u'OME Team'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-ome-zarr Documentation',
     [author], 1)
]
